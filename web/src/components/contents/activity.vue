  ...
  <div class='progress-box'>
    <div class='progress-picture'>
      <div class='picture-box'>
        <img v-if="currentTickets >0 &&  currentTickets < 3201"  src="../../assets/imgs/icon1_in.png" alt="">
        <img v-else-if='currentTickets == 0 || currentTickets >6401'  src="../../assets/imgs/icon1_small.png" alt="">
        <img v-else-if="currentTickets >= 3201 && currentTickets <= 6400"  src="../../assets/imgs/icon1_big.png" alt="">
        <div class='price'><div>408,888TRX</div></div>
      </div>
      <div class='picture-box'>
        <img v-if='currentTickets < 3201 || currentTickets > 12001'   src="../../assets/imgs/icon2_small.png" alt="">
        <img v-else-if="currentTickets >= 6401 && currentTickets <= 12000"  src="../../assets/imgs/icon2_big.png" alt="">
        <img v-else-if="currentTickets >=3201 &&  currentTickets < 6401"  src="../../assets/imgs/icon2_in.png" alt="">
        <div class='price'><div>828,888TRX</div></div>
      </div>
      <div class='picture-box'>
        <img v-if="currentTickets >= 6401 && currentTickets < 12001"  src="../../assets/imgs/icon3_in.png" alt="">
        <img v-else-if='currentTickets < 12001 || currentTickets > 31500'  src="../../assets/imgs/icon3_small.png" alt="">
        <img v-else-if="currentTickets >= 12001 && currentTickets <= 31500"  src="../../assets/imgs/icon3_big.png" alt="">
        <div class='price'><div>1,566,666TRX</div></div>
      </div>
      <div class='picture-box'>
        <img v-if="currentTickets >= 12001 && currentTickets < 31507" src="../../assets/imgs/icon4_in.png" alt="">
        <img v-else-if='currentTickets <31507 || currentTickets > 77500' src="../../assets/imgs/icon4_small.png" alt="">
        <img v-else-if="currentTickets >= 31507 && currentTickets <= 77500" src="../../assets/imgs/icon4_big.png" alt="">
        <div class='price'><div>4,066,666TRX</div></div>
      </div>
      <div class='picture-box'>
        <img v-if="currentTickets >= 31507 && currentTickets < 77500" src="../../assets/imgs/icon5_in.png" alt="">
        <img v-else-if='currentTickets < 77500'   src="../../assets/imgs/icon5_small.png" alt="">
        <img v-else-if="currentTickets >= 77500"  src="../../assets/imgs/icon5_big.png" alt="">
    ...
    <div class='progress-content'>
      ...
      <div class='coupons' style='font-size:12px;color:#fff;text-align:right;'><p style='position:relative;left:16px;'>{{coupons}}%</p></div>
    ...
    <div style="width:980px;margin-bottom: 30px;">
      <table  algin="right">
        <tr>
          <td><span class="trxsty">3,200{{$t('betting.copies')}}&nbsp;</span></td>
          <td><span class="trxsty">6,400{{$t('betting.copies')}}&nbsp;</span></td>
          <td><span class="trxsty">12,000{{$t('betting.copies')}}</span></td>
          <td><span class="trxsty">31,500{{$t('betting.copies')}}</span></td>
          <td><span class="trxsty">77,500{{$t('betting.copies')}}</span></td>
        </tr>
      </table>
    </div>
  </div>
  <div style="width:980px;margin-bottom: 40px;margin: 0 auto;">
    <span v-if="langularType == 'en'"  style="color:#0CD584;font-size:30px;margin-right:200px;">{{$t('betting.TotalLottery')}}: {{currentTickets}}</span>
    <span v-if="langularType == 'zh'"  style="color:#0CD584;font-size:30px;margin-right:420px">{{$t('betting.TotalLottery')}}: {{currentTickets}}</span>
      <a href="#buyTicket"> <el-button plain>{{$t('betting.Buy')}}</el-button></a>&nbsp;&nbsp;
      <a href="#myTicket"> <el-button plain>{{$t('betting.MyTicket')}}</el-button></a>
  </div>
  </div>
</template>  
